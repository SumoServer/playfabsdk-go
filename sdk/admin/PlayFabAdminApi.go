...
// CreateCloudScriptAzureFunctionsTask create a CloudScript task, which can run a CloudScript on a schedule.
// https://api.playfab.com/Documentation/Admin/method/CreateCloudScriptAzureFunctionsTask
func CreateCloudScriptAzureFunctionsTask(settings *playfab.Settings, postData *CreateCloudScriptAzureFunctionsTaskRequestModel, developerSecretKey string) (*CreateTaskResultModel, error) {
    if developerSecretKey == "" {
        return nil, playfab.NewCustomError("developerSecretKey should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Admin/CreateCloudScriptAzureFunctionsTask", "X-SecretKey", developerSecretKey)
    if err != nil {
        return nil, err
    }
...
// GetCloudScriptAzureFunctionsTaskInstance get detail information about a CloudScript Azure Functions task instance.
// https://api.playfab.com/Documentation/Admin/method/GetCloudScriptAzureFunctionsTaskInstance
func GetCloudScriptAzureFunctionsTaskInstance(settings *playfab.Settings, postData *GetTaskInstanceRequestModel, developerSecretKey string) (*GetCloudScriptAzureFunctionsTaskInstanceResultModel, error) {
    if developerSecretKey == "" {
        return nil, playfab.NewCustomError("developerSecretKey should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Admin/GetCloudScriptAzureFunctionsTaskInstance", "X-SecretKey", developerSecretKey)
    if err != nil {
        return nil, err
    }
    
    result := &GetCloudScriptAzureFunctionsTaskInstanceResultModel{}
