...
// SetAvatarUrl update the avatar url of the entity
// https://api.playfab.com/Documentation/Profiles/method/SetAvatarUrl
func SetAvatarUrl(settings *playfab.Settings, postData *SetAvatarUrlRequestModel, entityToken string) (*SetAvatarUrlResponseModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Profile/SetAvatarUrl", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
    
    result := &SetAvatarUrlResponseModel{}
...
// SetDisplayName update the display name of the entity
// https://api.playfab.com/Documentation/Profiles/method/SetDisplayName
func SetDisplayName(settings *playfab.Settings, postData *SetDisplayNameRequestModel, entityToken string) (*SetDisplayNameResponseModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Profile/SetDisplayName", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
    
    result := &SetDisplayNameResponseModel{}
