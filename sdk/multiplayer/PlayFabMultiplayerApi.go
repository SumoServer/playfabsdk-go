...
// EnablePartiesForTitle enables the parties feature for a title.
// https://api.playfab.com/Documentation/Multiplayer/method/EnablePartiesForTitle
func EnablePartiesForTitle(settings *playfab.Settings, postData *EnablePartiesForTitleRequestModel, entityToken string) (*EmptyResponseModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Party/EnablePartiesForTitle", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
...
// GetCognitiveServicesToken gets a token for the cognitive services based on the specified service type.
// https://api.playfab.com/Documentation/Multiplayer/method/GetCognitiveServicesToken
func GetCognitiveServicesToken(settings *playfab.Settings, postData *GetCognitiveServicesTokenRequestModel, entityToken string) (*GetCognitiveServicesTokenResponseModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/MultiplayerServer/GetCognitiveServicesToken", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
    
    result := &GetCognitiveServicesTokenResponseModel{}
...
// GetMatchmakingQueue get a matchmaking queue configuration.
// https://api.playfab.com/Documentation/Multiplayer/method/GetMatchmakingQueue
func GetMatchmakingQueue(settings *playfab.Settings, postData *GetMatchmakingQueueRequestModel, entityToken string) (*GetMatchmakingQueueResultModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Match/GetMatchmakingQueue", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
    
    result := &GetMatchmakingQueueResultModel{}
...
// ListMatchmakingQueues list all matchmaking queue configs.
...
// RemoveMatchmakingQueue remove a matchmaking queue config.
// https://api.playfab.com/Documentation/Multiplayer/method/RemoveMatchmakingQueue
func RemoveMatchmakingQueue(settings *playfab.Settings, postData *RemoveMatchmakingQueueRequestModel, entityToken string) (*RemoveMatchmakingQueueResultModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Match/RemoveMatchmakingQueue", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
    
    result := &RemoveMatchmakingQueueResultModel{}
...
// RequestParty request a party session.
// https://api.playfab.com/Documentation/Multiplayer/method/RequestParty
func RequestParty(settings *playfab.Settings, postData *RequestPartyRequestModel, entityToken string) (*RequestPartyResponseModel, error) {
    if entityToken == "" {
        return nil, playfab.NewCustomError("entityToken should not be an empty string", playfab.ErrorGeneric)
    }
    b, errMarshal := json.Marshal(postData)
    ...
    sourceMap, err := playfab.Request(settings, b, "/Party/RequestParty", "X-EntityToken", entityToken)
    if err != nil {
        return nil, err
    }
    
    result := &RequestPartyResponseModel{}
...
// SetMatchmakingQueue create or update a matchmaking queue configuration.
